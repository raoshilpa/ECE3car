...
const unsigned long long_period  = 100e3; // 1 s
...
// This function loops forever
  ...
  digitalWrite(left_nslp_pin, 1); // as noted before, this allows the left motor to coast
  digitalWrite(left_pwm_pin, pwm_state);

  digitalWrite(right_nslp_pin, 0); // as noted before, this allows the left motor to coast
